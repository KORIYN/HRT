...
#%%
img_dir = os.path.join(NFS_path,'CUB/')
file_paths = os.path.join(NFS_path,'xlsa17/data/CUB/res101.mat')
save_path = '/data/wgr/code/HRT/data/CUB/1feature_map_ResNet_101_CUB.hdf5'
attribute_path = '/data/wgr/code/HRT/w2v/CUB_attribute.pkl'
#pdb.set_trace()
...
#%%
pretrain_model = models.resnet101(num_classes=1000)
pretrain_model.load_state_dict(torch.load('./resnet101-5d3b4d8f.pth'))
...
split_path = os.path.join(NFS_path,'xlsa17/data/CUB/att_splits.mat')
