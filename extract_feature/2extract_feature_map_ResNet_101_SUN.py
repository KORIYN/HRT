...
img_dir = os.path.join(NFS_path,'SUN/')
file_paths = os.path.join(NFS_path,'xlsa17/data/SUN/res101.mat')
save_path = '/data/wgr/code/HRT/data/SUN/2feature_map_ResNet_101_CUB.hdf5'
attribute_path = '/data/wgr/code/HRT/w2v/SUN_attribute.pkl'
#pdb.set_trace()
...
split_path = os.path.join(NFS_path,'xlsa17/data/SUN/att_splits.mat') 
