...
img_dir = os.path.join(NFS_path,'data/AWA2/')
mat_path = os.path.join(NFS_path,'data/xlsa17/data/AWA2/res101.mat')
...
class AWA2DataLoader():
    ...
    def read_matdataset(self):
        ...
        path_fa = self.data_path +'factor_analysis/AWA2_init_w2v_att_fa.hdf5'
