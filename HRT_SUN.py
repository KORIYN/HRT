...
dataloader = SUNDataLoader(NFS_path,is_unsupervised_attr=False,is_balance=True)
...
elif mode == 'MultiStep52':
    optimizer = optim.RMSprop( params_to_update ,lr=lr,weight_decay=weight_decay, momentum=momentum)
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer,
                        milestones=[ 52], gamma=0.1)
...
for i in range(0,niters):
    ...
    batch_label, batch_feature, batch_att = dataloader.next_batch(batch_size) #[50],[50, 2048, 14, 14],[50, 312]
